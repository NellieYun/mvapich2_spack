...
class Mvapich2(AutotoolsPackage):
    ...
    def network_options(self):
        ...
        if 'fabrics=psm' in self.spec:
            opts = [
              ...
              #  "--with-psm-lib=/nv/ap5/usr-local-rhel7.4/pacerepov2/spack/opt/spack/linux-rhel7-x86_64/intel-18.0.1/psm-3.3-3ppmjwgssklksgrwmgifvwtp3upz7b6y/lib64"
            ]
    ...
    def setup_environment(self, spack_env, run_env):
        ...
        #spack_env.set('CC','icc')
        #spack_env.set('CXX','icpc')
        #spack_env.set('FC','ifort')
        #spack_env.set('F77','ifort')
        if 'process_managers=slurm' in spec:
    ...
    def configure_args(self):
        ...
        args = [
            ...
            "CC=/nv/ap5/usr-local-rhel7.4/pacerepov2/spack/opt/spack/linux-rhel7-x86_64/gcc-4.8.5/intel-18.0.1-7cbw2rpdcuv3hpj2txc4wqcjnjeiv7n6/compilers_and_libraries_2018.1.163/linux/bin/intel64/icc",
            "CXX=/nv/ap5/usr-local-rhel7.4/pacerepov2/spack/opt/spack/linux-rhel7-x86_64/gcc-4.8.5/intel-18.0.1-7cbw2rpdcuv3hpj2txc4wqcjnjeiv7n6/compilers_and_libraries_2018.1.163/linux/bin/intel64/icpc",
            "FC=/nv/ap5/usr-local-rhel7.4/pacerepov2/spack/opt/spack/linux-rhel7-x86_64/gcc-4.8.5/intel-18.0.1-7cbw2rpdcuv3hpj2txc4wqcjnjeiv7n6/compilers_and_libraries_2018.1.163/linux/bin/intel64/ifort",
            "F77=/nv/ap5/usr-local-rhel7.4/pacerepov2/spack/opt/spack/linux-rhel7-x86_64/gcc-4.8.5/intel-18.0.1-7cbw2rpdcuv3hpj2txc4wqcjnjeiv7n6/compilers_and_libraries_2018.1.163/linux/bin/intel64/ifort"
        ]
